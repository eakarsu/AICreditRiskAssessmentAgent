...
/**
 * Gap/CFS Feature Page: `assessments` lacks AI-driven underwriting copilot.
 * Slug: assessments-lacks-ai-driven-underwriting-copilot
 * Backend: /api/gap-assessments-lacks-ai-driven-underwriting-copilot
 */
export default function AssessmentsLacksAiDrivenUnderwritingCopilotPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-assessments-lacks-ai-driven-underwriting-copilot', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`assessments` lacks AI-driven underwriting copilot.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`assessments` lacks AI-driven underwriting copilot.</p>
