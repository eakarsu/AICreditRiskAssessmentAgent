...
/**
 * Gap/CFS Feature Page: Portfolio concentration analysis
 * Slug: portfolio-concentration-analysis
 * Backend: /api/cf-portfolio-concentration-analysis
 */
export default function PortfolioConcentrationAnalysisPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-portfolio-concentration-analysis', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Portfolio concentration analysis</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Identify sector/geographic concentrations; recommend hedging or diversification.</p>
