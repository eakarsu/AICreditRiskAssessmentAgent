...
/**
 * Gap/CFS Feature Page: No loan-officer mobile app.
 * Slug: no-loan-officer-mobile-app
 * Backend: /api/gap-no-loan-officer-mobile-app
 */
export default function NoLoanOfficerMobileAppPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-loan-officer-mobile-app', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No loan-officer mobile app.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No loan-officer mobile app.</p>
