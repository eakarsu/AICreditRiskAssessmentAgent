...
/**
 * Gap/CFS Feature Page: Predictive default modeling
 * Slug: predictive-default-modeling
 * Backend: /api/cf-predictive-default-modeling
 */
export default function PredictiveDefaultModelingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-default-modeling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive default modeling</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model predicts probability of default within 6/12/24 months; trigger proactive interventions.</p>
