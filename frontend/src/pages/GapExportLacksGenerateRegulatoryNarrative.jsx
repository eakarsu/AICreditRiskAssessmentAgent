...
/**
 * Gap/CFS Feature Page: `export` lacks `/generate-regulatory-narrative`.
 * Slug: export-lacks-generate-regulatory-narrative
 * Backend: /api/gap-export-lacks-generate-regulatory-narrative
 */
export default function ExportLacksGenerateRegulatoryNarrativePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-export-lacks-generate-regulatory-narrative', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`export` lacks `/generate-regulatory-narrative`.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`export` lacks `/generate-regulatory-narrative`.</p>
