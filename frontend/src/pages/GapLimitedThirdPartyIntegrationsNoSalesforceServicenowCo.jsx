...
/**
 * Gap/CFS Feature Page: Limited third-party integrations — no Salesforce/ServiceNow/core-banking adapters.
 * Slug: limited-third-party-integrations-no-salesforce-servicenow-co
 * Backend: /api/gap-limited-third-party-integrations-no-salesforce-servicenow-co
 */
export default function LimitedThirdPartyIntegrationsNoSalesforceServicenowCoPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-third-party-integrations-no-salesforce-servicenow-co', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited third-party integrations — no Salesforce/ServiceNow/core-banking adapters.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited third-party integrations — no Salesforce/ServiceNow/core-banking adapters.</p>
