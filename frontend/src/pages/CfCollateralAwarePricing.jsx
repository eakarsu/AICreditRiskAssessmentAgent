...
/**
 * Gap/CFS Feature Page: Collateral-aware pricing
 * Slug: collateral-aware-pricing
 * Backend: /api/cf-collateral-aware-pricing
 */
export default function CollateralAwarePricingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-collateral-aware-pricing', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Collateral-aware pricing</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Dynamic pricing that accounts for collateral liquidation risk and correlation with credit risk.</p>
